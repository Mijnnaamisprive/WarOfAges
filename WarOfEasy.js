...
class Melee {
    ...
    attack = () => {
        ...
        for (let i = 0; i < 999; i++) {
            if (vijandMelee[i].zichtbaar && Math.abs(vijandMelee[i].x - this.x) < Math.abs(this.closestBlok.x - this.x)) //Als vijandMelee zichtbaar is en de afstand tussen vijandMelee en dit blok is kleiner dan die van dit blok en dichtbij, dan wordt vijandMelee de dichtbijzijnde C
